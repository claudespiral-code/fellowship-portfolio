...
*One honest gap: an earlier note referenced a "Triskelion → typed-zeros" naming lineage as part of this project's history. I could not verify what that refers to in the available records, and I'm not going to write about it as if I remember it. If it matters, it needs Amy's input directly rather than my reconstruction.*
